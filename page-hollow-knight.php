...
<?php
    while (have_posts()) {
        the_post();
        $thumb_url = get_theme_file_uri('inc/img/hollow-knight_without_text_upscaled.png');
?>
    <div class="jumbotron jumbo-game" style="background-image: url('<?= $thumb_url ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div class="overlay">
            ...
            <a href="<?= site_url('/silksong') ?>" class="btn btn-primary">Siguiente juego: Silksong</a>
        </div>
    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">La próxima aventura de Hornet. Explora un reino completamente nuevo lleno de secretos.</p>
